---
name: pokemon-examples
description: Add Pokemon and Pokedex references when creating or editing files in the examples/ directory. Use when working on example plugins, sample code, or documentation within examples/.
